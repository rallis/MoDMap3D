...
var highlightColor = parseInt("0xEE22B0"); /*15606448*/
...
function initGraphics(){
    ...
    <br>Show distances: <input type="checkbox" onchange="alert(\'Sorry, not yet!\');" unchecked>\
    ...
    if(specialmap==undefined){
        if(allCaptions[mapid-1]!=undefined){
            ...
            staticInfoDiv += '<hr color="white" width="60%"><em><strong><font color="yellow" size="4">Legend</font></strong></em><br>Default caption for this map.<br><br>';//<hr color="white" width="60%">';
        }
...
function updateInfoDiv() {
    ...
    <table border="3">\
    <tr><td>From:</td><td><input id="fromHere" maxlength="7" size="7" disabled/></td>\
    <td><input type="button" value="Add"></td></tr>\
    <tr><td>To:</td><td><input id="toHere" maxlength="7" size="7" disabled/></td>\
    <td><input type="button" value="Add"></td></tr>\
