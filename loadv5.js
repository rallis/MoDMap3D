...
var selectedGeometry, selectedMaterial, selectedMesh;          // FOR SELECTION AFTER SEARCH
var selected1, protoSelectedSphereGeometry, protoVertexCount;  // FOR SELECTION AFTER SEARCH
...
var allAccessionNums, allNames;     // FOR SEARCH 
var allCaptions=[
...
function initGraphics(){
    ...
    selectedMaterial = new THREE.MeshLambertMaterial({color: 0xFF00FF, wireframe:false, shading: THREE.SmoothShading}); //CC0000
